...
class BatchServiceAsyncClient:
    ...
    common_billing_account_path = staticmethod(BatchServiceClient.common_billing_account_path)
    parse_common_billing_account_path = staticmethod(BatchServiceClient.parse_common_billing_account_path)
    ...
    parse_common_organization_path = staticmethod(BatchServiceClient.parse_common_organization_path)
    common_project_path = staticmethod(BatchServiceClient.common_project_path)
    parse_common_project_path = staticmethod(BatchServiceClient.parse_common_project_path)
    common_location_path = staticmethod(BatchServiceClient.common_location_path)
    parse_common_location_path = staticmethod(BatchServiceClient.parse_common_location_path)
    ...
    get_transport_class = functools.partial(type(BatchServiceClient).get_transport_class, type(BatchServiceClient))
