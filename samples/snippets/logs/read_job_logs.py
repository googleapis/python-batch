...
def get_job_logs(project_id: str, job: batch_v1.Job) -> Iterable[logging.TextEntry]:
    """
    Get logs generated by given job from Cloud Logging.

    Args:
        project_id: name of the project hosting the job.
        job: the job which logs you want to retrieve.

    Returns:
        An iterable containing google.cloud.logging.TextEntry objects representing
        retrieved logs.
    """
    ...
    return logger.list_entries(filter_=f"labels.job_uid={job.uid}")
